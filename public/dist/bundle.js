...
/***/ function(module, exports, __webpack_require__) {
	...
	var Buscador = __webpack_require__(230);
	var Item = __webpack_require__(236);
	var Resultado = __webpack_require__(256);
	...
	ReactDOM.render(React.createElement(
	  Router,
	  { history: reactRouter.browserHistory, onUpdate: function () {
	      window.scrollTo(0, 0);
	    } },
	  React.createElement(
	    Route,
	    { path: '/', component: App },
	    React.createElement(Route, { path: 'buscar', component: Buscador }),
	    React.createElement(Route, { path: 'resultado', component: Resultado }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Buscador = __webpack_require__(231);
	...
	var App = React.createClass({
	  ...
	  render: function () {
	    return React.createElement(
	      ...
	      React.createElement(Buscador, { cuandoAlguienEnvie: this.onCuandoAlguienEnvie })
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".buscador{\n\n}", ""]);
	...
	var App = React.createClass({
	  ...
	  render: function () {
	    return React.createElement(
	      ...
	      React.createElement('img', { src: this.state.detail.thumbnail })
	    );
	  }
	});
